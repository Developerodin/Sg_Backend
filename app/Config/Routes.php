...
$routes->post('/users/reset_pass/(:num)', 'Users::reset_pass/$1');
...
$routes->post('/users/post_published/(:num)', 'Users::post_published/$1');
$routes->post('/users/post_like/(:num)', 'Users::post_like/$1');
$routes->post('/users/user_update/(:num)', 'Users::user_update/$1');
$routes->delete('/users/post_delete_id/(:num)', 'Users::destroy/$1');
$routes->get('/users/get_drafts/(:num)', 'Users::get_drafts/$1');
